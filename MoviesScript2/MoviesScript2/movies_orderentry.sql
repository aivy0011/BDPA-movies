...
CREATE TABLE `orderentry` (
  `idorderentry` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`idorderentry`),
  UNIQUE KEY `customerid` (`customerid`),
  KEY `custid_indx` (`customerid`)
...
INSERT INTO `orderentry` VALUES (1,'2012-06-28','2012-07-01','UPS',1,'VISA',35.70);
...
-- Dump completed on 2012-07-24 15:13:30
